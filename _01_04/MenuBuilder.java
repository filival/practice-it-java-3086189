...
public class MenuBuilder {
  public static void main(String[] args) {
    ...
    MenuItem starter = new MenuItem("Giant champagne and lemon prawn vol-au-vents");
    ...
    MenuItem mainCourse = new MenuItem("Salmon en Croûte");
    ...
    MenuItem dessert = new MenuItem("Lemon Meringue Pie Shooters");
